...
export const AddMySQL: React.FC<ElementProps> = ({onSizeChange}) => {
  ...
  return (
    <div style={{maxWidth: '600px', width:'100%'}}>
      ...
      >
        <Legend>Add remote MySQL Instance</Legend>
        ...
        <Field label='Port'>
          <Input {...register('port')} defaultValue={3306} placeholder='Port (default: 3306)' type='number' />
        </Field>
